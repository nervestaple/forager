...
const targetPortalKey = 'targetPortalKey';
const portedGameObjectKey = 'portedGameObjectKey';
...
export default function ScenePortal({
  ...
  useGameEvent<SceneInitEvent>(
    'scene-init',
    () => {
      const targetName = getGameState(targetPortalKey as string);
